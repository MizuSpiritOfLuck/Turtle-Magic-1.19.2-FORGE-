...
@OnlyIn(Dist.CLIENT)
public class SnapperFangsModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public SnapperFangsModel(ModelPart part) {
        this.root = part;
        this.base = part.getChild("base");
        this.upperJaw = part.getChild("upper_jaw");
        this.lowerJaw = part.getChild("lower_jaw");
    }
