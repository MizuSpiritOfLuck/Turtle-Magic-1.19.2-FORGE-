...
public class TwirlingShellEntityBackup extends Monster implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);
    LivingEntity summoner;
    private boolean hasLimitedLife;
    private int limitedLifeTicks;

    public TwirlingShellEntityBackup(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }

    public TwirlingShellEntityBackup(Level level, double d1, double d2, double d3, LivingEntity entity) {
